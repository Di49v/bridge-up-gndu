...
import { Heart, MessageSquare, Plus, Calendar, Target } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {suggestions.length === 0 && (
          <div className="bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No Tips Yet</h3>
            <p className="text-gray-600 mb-6">
              Be the first senior to share valuable advice for your juniors!
            </p>
            <button
